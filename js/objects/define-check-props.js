...
const ob1 = {};
// define multiple props at once, to define only one => Object.defineProperty(ob, {prop});
Object.defineProperties(ob1, {
    name : { enumerable: false, configurable: true, writable: false, value: 'Iri' },
    time: { enumerable: false, configurable: true, writable: false, value: new Date().toLocaleTimeString() }});
...
console.log('name in cat after deletion in ob1: ', ob2.name); // since it was non-writable thus non-overritable

// checking own props
console.log('is prop "time" in ob1: ', 'time' in ob1, '; time is: ', ob1.time);
...
console.log('check if prop "age" is defined in cat: ', ob2.age !== undefined);
